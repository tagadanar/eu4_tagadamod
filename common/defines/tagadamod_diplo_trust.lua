...
NDefines.NDiplomacy.DISHONOR_CALL_TRUST_CALLER = 35 -- 20 -- How much trust is lost from dishonoring a call to arms (with caller).
NDefines.NDiplomacy.DISHONOR_CALL_TRUST = 10 -- 5 -- How much trust is lost from dishonoring a call to arms (with everyone else).
NDefines.NDiplomacy.TRUST_PENALTY_FOR_NO_LAND = 35 -- 20 -- Trust penalty for not being given as much land as they expected in peace deal (scales with how much they actually got relative to participation).
NDefines.NDiplomacy.TRUST_PENALTY_FOR_SEPARATE_PEACE = 20 -- 10 -- Trust penalty for signing a separate peace
